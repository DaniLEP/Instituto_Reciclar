...
export default function RelatorioHortalicas() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulação de dados
    const dadosExemplo = [
    { sku: "123443223", fornecedor: 'Ceagesp', produto: 'Alface', quantidade: 100, tipo: "Verdura", unidade: 'kg', pesoTotal: 100, pesoUnitario: 2, dataCadastro: '2023-09-01', dataVencimento: '2024-09-01' },
      { sku: "123123123", fornecedor: 'Hort-Fruit', produto: 'Banana', quantidade: 50, tipo: "Fruta", unidade: 'kg', pesoTotal: 50, pesoUnitario: 4, dataCadastro: '2023-08-15', dataVencimento: '2024-08-15' },
    ];
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, 'relatorio_hortalicas.xlsx');
  };
  ...
  return (
    ...
    <div style={{ background: "#00009C", display: "flex", flexDirection: "column", alignItems: "center", margin: "0", padding: "20px", minHeight: "100vh", overflow: "hidden" }}>
      <div style={{ backgroundColor: "#fff", padding: "24px", borderRadius: "8px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)", width: "94%", maxWidth: "1200px", margin: "5px 0" }}>
        <h1 className='text-center text-black text-[35px]'>Relatório de Hortaliças</h1>
          ...
          <tbody>
            {dadosTabela.map((dado, index) => (
              <tr key={index} style={{ backgroundColor: index % 2 === 0 ? "#f9f9f9" : "#fff", textAlign: "center" }}>
                ...
                <td style={{ padding: "10px", borderBottom: "1px solid #ddd" }}>{dado.tipo}</td>
