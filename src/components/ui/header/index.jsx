...
//           <Link to="/Pedidos" className="hover:text-[#00FF62] transition">Pedidos/Compras</Link>
...
//           <Link to="/Verificacao_Usuario" className="hover:text-[#00FF62] transition">Gerenciador de Usuários</Link> 
//           <Link to="/Estoque" className="hover:text-[#00FF62] transition">Estoque </Link>
//           <Link to="/cardapio" className="hover:text-[#00FF62] transition">Cardápio / Ficha Técnica / Refeições</Link>
...
//           <Link to="#" className="hover:text-[#00FF62] transition" onClick={handleClick}>Pedidos/Compras </Link> 
...
//           <Link to="/Verificacao_Usuario"  className="hover:text-[#00FF62] transition"  onClick={handleClick}>Gerenciador de Usuários </Link>
