...
export default function RelatorioMantimento() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulação de dados
    const dadosExemplo = [
    { sku: "123443223", fornecedor: 'SuperMercado', produto: 'Arroz', quantidade: 100, unidade: 'kg', pesoTotal: 100, pesoUnitario: 2, dataCadastro: '2023-09-01', dataVencimento: '2024-09-01' },
      { sku: "123123123", fornecedor: 'Assái', produto: 'Macarrão', quantidade: 50, unidade: 'kg', pesoTotal: 50, pesoUnitario: 4, dataCadastro: '2023-08-15', dataVencimento: '2024-08-15' },
    ];
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, 'relatorio_mantimento.xlsx');
  };
  ...
  const gerarGrafico = (dados) => {
    ...
    const novoGrafico = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Quantidade de Mantimento',
  ...
  return (
    ...
    <div style={{ background: "#00009C", display: "flex", flexDirection: "column", alignItems: "center", margin: "0", padding: "20px", minHeight: "100vh", overflow: "hidden" }}>
      <div style={{ backgroundColor: "#fff", padding: "24px", borderRadius: "8px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)", width: "94%", maxWidth: "1200px", margin: "5px 0" }}>
        <h1 className='text-center text-black text-[35px]'>Relatório de Mantimento</h1>
