...
//         <div style={{maxWidth: "340px", height: "190px", margin: "0 auto", position:"relative", top:"23vh", right: "35vh", backgroundColor: "#fff", padding: "20px", borderRadius: "8px", color: "black", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)"}}>
//             <br />
...
//           <img src='/public/plus.svg' className='w-60 h-20 align-center' />
//           <br />
