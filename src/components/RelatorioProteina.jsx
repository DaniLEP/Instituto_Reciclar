...
export default function RelatorioDoacoes() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulação de dados
    const dadosExemplo = [
    { fornecedor: 'Friboi', produto: 'Coxão Mole', quantidade: 100, unidade: 'kg', tipo: "BOVINA" , pesoTotal: 100, pesoUnitario: 1, dataCadastro: '2023-09-01', dataVencimento: '2024-09-01' },
      { fornecedor: 'Mais Brasil', produto: 'Coxa de Frango', quantidade: 50, unidade: 'kg', tipo: "AVE", pesoTotal: 50, pesoUnitario: 1, dataCadastro: '2023-08-15', dataVencimento: '2024-08-15' },
    ];
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, 'relatorio_proteina.xlsx');
  };
  ...
  return (
    ...
    <div style={{ background: "#00009C", display: "flex", flexDirection: "column", alignItems: "center", margin: "0", padding: "20px", minHeight: "100vh", overflow: "hidden" }}>
      <div style={{ backgroundColor: "#fff", padding: "24px", borderRadius: "8px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)", width: "94%", maxWidth: "1200px", margin: "5px 0" }}>
        <h1 className='text-center text-black text-[35px]'>Relatório de Proteínas</h1>
