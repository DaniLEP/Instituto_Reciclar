...
export default function Relatorio() {
  return (
    <>
      <div
        style={{ minHeight: "100vh", padding: "20px 0", display: "flex",  alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #6a11cb, #2575fc)", }} >
        <div className=" mx-auto px-4 text-center">
          {/* Título Responsivo */}
          <span className="text-white font-bold  font-[Novatica Bold] text-8xl md:text-6xl lg:text-8xl mb-[10px]"> Relatórios</span>
