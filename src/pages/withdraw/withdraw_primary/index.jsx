...
setFilteredProdutos(filtered)
  ...
  const handleProdutoSelecionado = (produto) => {
    ...
    setQuantidadeDisponivel(Number(produto.quantity) || 0)
    setQuantity("")
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Button
              ...
              onClick={() => navigate("/home-retirada")}
            >
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <Label htmlFor="sku" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                        <Hash className="w-4 h-4 text-blue-500" /> SKU do Produto
                      </Label>
                      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                        <DialogTrigger asChild>
                          <div className="relative">
                            <Input
                              id="sku"
                              placeholder={sku ? sku : "Clique para selecionar produto"}
                              value={sku}
                              readOnly
                        ...
                        <DialogContent className="w-full max-w-5xl max-h-[85vh] flex flex-col">
                          ...
                          <div className="flex-1 flex flex-col gap-6 min-h-0">
                              ...
                              {searchTerm && (
                                <div className="flex items-center justify-between">
                                  <p className="text-sm text-gray-600">
                                    <span className="font-medium">{filteredProdutos.length}</span> produto(s)
                                    encontrado(s)
                                  </p>
                                  {searchTerm && (
                                    <Button
                                ...
                                <div className="flex flex-col items-center justify-center py-16 text-gray-500">
                                  ...
                                  <p className="text-center max-w-md">
                                    {searchTerm
                                      ...
                                      : "Não há produtos disponíveis no estoque no momento"}
                                  </p>
                                </div>
                              ) : (
                            ...
                            <div className="flex-shrink-0 flex items-center justify-between pt-6 border-t bg-gray-50 -mx-6 px-6 -mb-6 pb-6 rounded-b-lg">
                              ...
                              <Button variant="outline" onClick={() => setIsModalOpen(false)} size="lg">
                                Cancelar
                              </Button>
                            </div>
                          </div>
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="produto" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                        <Package className="w-4 h-4 text-green-500" /> Nome do Produto
                      </Label>
                      <Input
                        id="produto"
                        value={name}
                        readOnly
                        className="bg-gray-50 h-12 border-gray-200"
                        placeholder="Produto será preenchido automaticamente"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="marca" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                          <Tag className="w-4 h-4 text-orange-500" /> Marca
                        </Label>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          <Layers className="w-4 h-4 text-purple-500" /> Categoria
                        </Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="tipo" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                          <Package className="w-4 h-4 text-indigo-500" /> Tipo
                        </Label>
                        <Input id="tipo" value={tipo} readOnly className="bg-white border-gray-200 h-11" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="peso" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={`${quantidadeDisponivel} unidades`}
                          readOnly
                          className="bg-green-50 border-green-200 h-11 font-semibold text-green-700"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <Label htmlFor="quantidade" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                        <ShoppingCart className="w-4 h-4 text-blue-500" /> Quantidade a Retirar
                      </Label>
                      <Input
                        id="quantidade"
                        type="number"
                      ...
                      {quantity && quantidadeDisponivel > 0 && (
                        <p className="text-sm text-gray-600">
                          ...
                          <span className="font-semibold text-green-600">
                            {quantidadeDisponivel - Number(quantity)} unidades
                          </span>
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        placeholder="Quem está retirando o produto?"
                        className="h-12 text-lg border-2 focus:border-purple-500"
                      />
                    </div>

                    <div className="space-y-3 md:col-span-2">
                      <Label htmlFor="dataPedido" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                        <Calendar className="w-4 h-4 text-green-500" /> Data da Retirada
                      </Label>
                      <Input
                        id="dataPedido"
                        type="date"
                        ...
                        className="h-12 text-lg border-2 focus:border-green-500 max-w-xs"
                      />
                    </div>
                  </div>
                </div>
