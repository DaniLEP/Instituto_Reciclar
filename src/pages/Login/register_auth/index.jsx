...
//       await set(ref(dbRealtime, 'usuarios/' + newUser.uid), { nome, email, funcao: tipoUsuario, uid: newUser.uid, status: "offline"});
...
//           {/* NOME */}
//           <Input type="text" value={nome} onChange={(e) => setNome(e.target.value)} requiredplaceholder="Nome"  className="w-full p-4 border border-gray-300 rounded-lg bg-gray-50 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
//           {/* E-MAIL */}
...
//           {/* FUNÇÃO */}
//           <select  value={funcao}  onChange={(e) => setFuncao(e.target.value)}  required className="w-full p-1 border border-gray-300 rounded-lg bg-gray-50 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" >
...
//             >{isLoading ? 'Carregando...' : 'Criar Conta'}</Button>
//             <Link to="/Verificacao_Usuario">
//               <Button type="button"
//                 className="w-full md:w-auto px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-xl font-semibold shadow-md">Voltar</Button>
//             </Link>
//           </div>
//         </form>
