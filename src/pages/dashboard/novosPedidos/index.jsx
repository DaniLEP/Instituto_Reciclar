    ...
    <Box p={3} sx={{ background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <Grid container spacing={3} mb={4}>
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <Typography variant="caption" sx={{ opacity: 0.85, fontWeight: 600, letterSpacing: "0.5px" }}>
              Total Investido
            </Typography>
            <Typography variant="h5" sx={{ fontWeight: 900, my: 1.5, fontSize: "1.75rem" }}>
              {formatBR(totals.totalValor ?? 0)}
            </Typography>
            <Typography variant="caption" sx={{ opacity: 0.75, fontSize: "0.8rem" }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card
            sx={{
              ...
              transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
              "&:hover": {
                boxShadow: "0 16px 32px rgba(3, 105, 161, 0.25)",
                transform: "translateY(-2px)",
              },
            }}
          >
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card
            sx={{
              ...
              transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
              "&:hover": {
                boxShadow: "0 16px 32px rgba(109, 40, 217, 0.25)",
                transform: "translateY(-2px)",
              },
            }}
          >
                ...
                <DataGrid
                  ...
                  columns={[
                    ...
                    { field: "fornecedor", headerName: "Fornecedor", flex: 1 },
                    {
                      ...
                      headerName: "Kg",
                      flex: 0.6,
                      valueFormatter: ({ value } = {}) => formatWeight(value || 0),
                    },
                    {
                      field: "totalValor",
                      headerName: "Valor",
                      flex: 0.8,
                      valueFormatter: ({ value } = {}) => formatBR(value || 0),
                    },
                  ]}
                  pageSize={6}
                  disableSelectionOnClick
