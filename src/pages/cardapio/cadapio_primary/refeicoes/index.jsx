  ...
  return (
    <div className="min-h-screen p-5 bg-gradient-to-br from-[#6a11cb] to-[#2575fc] flex justify-center items-center">
      <div className="text-center px-4">
        <h1 className="text-white font-bold text-6xl md:text-8xl">Refeições</h1>
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 mt-12">
          {/* Card 1 – Nova Retirada */}
          <Card link="/cadastro-refeicoes" imgSrc="/refeição.jpeg" title="Cadastrar" />
          <Card link="/refeicoes-servidas" imgSrc="/prancheta.png" title="Consultar " />
