...
useEffect(() => {
  const cardapioRef = ref(db, 'cardapiosAprovadosPorTipo/CafedaManha'); // Caminho ajustado
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-r from-blue-900 to-gray-800 text-white">
      ...
      >
        <Title className="text-4xl font-extrabold text-white">Consulta de Cardápio Café da Manhã</Title>
