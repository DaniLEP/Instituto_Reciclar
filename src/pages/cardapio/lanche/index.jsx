...
const secoes = ['Lanche Principal', 'Opção Vegetariana', 'Frutas', 'Bebida'];
...
const CardapioLanche = () => {
  ...
  const salvarCardapio = async () => {
    ...
    try {
      await set(ref(db, 'cardapioLanche'), dados);
  ...
  return (
    <div className="p-6 max-w-8xl mx-auto bg-gradient-to-r from-blue-900 to-gray-800">
      <div className="flex justify-between items-center mb-6">
        <Button onClick={() => navigate(-1)} className="bg-white hover:bg-gray-600 text-gray-800 px-4 py-2 rounded-md shadow">
